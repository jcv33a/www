...
class imgUpldrb {
	...
	private $_width = 800; // Ancho máximo por defecto
	private $_height = 600; // Alto máximo por defecto
	private $_size = 5242880; // Peso máximo. MAX_FILE_SIZE sobrescribe este valor
	...
	public function asignaNombre() { 
		...
		// Asignamos el nombre a la imagen según la fecha en formato aaaammddhhiiss y la extensión
		 ...
		 $this->_name = $_POST["nombre_eliminar"]."b";
		 
		 //$this->_name = $_POST["nombre_eliminar"].".".$this->_ext;

...
<body>
		...
		<ul id="picturelist">
	  		<li><a href="index.php"><img src="/images/xbg1.jpg"width="600" height="150"alt=""/></a></li>
			<br>
		</ul>
...
<div id ="container">
  <div id = "navdiv">
    <ul class = "mainlinks">
      ...
      <li><a href="addscore3.php" >insertar anuncio</a></li>
	  <li><a href="/index.php" >ver anuncios</a></li>
...
<form enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    <input type="text" id="provincia" name="provincia" value="<?php //if (!empty($provincia)) echo $provincia; ?>" /><br />
	-->
	
	<!-- <form action="<?php //echo $_SERVER["PHP_SELF"]?>" method="post">		<?php //este form action envia los formularios a la misma página de formulario?> -->
...
<!--		<select name="id_provincias">	<?php //esta linea entra en la base de datos y extrae todas las provincias por orde alfabetico de la tabla,muestra los registro de forma de ventana?>

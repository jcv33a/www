...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2014 a las 19:39:44
...
CREATE TABLE IF NOT EXISTS `mismatch_category` (
  ...
  `name` varchar(48) COLLATE latin1_spanish_ci DEFAULT NULL,
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=376 ;
...
CREATE TABLE IF NOT EXISTS `mismatch_topic` (
  ...
  `name` varchar(48) COLLATE latin1_spanish_ci DEFAULT NULL,
  `category` varchar(48) COLLATE latin1_spanish_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mismatch_user` (
  ...
  `username` varchar(32) COLLATE latin1_spanish_ci DEFAULT NULL,
  `password` varchar(40) COLLATE latin1_spanish_ci DEFAULT NULL,
  `join_date` datetime DEFAULT NULL,
  `first_name` varchar(32) COLLATE latin1_spanish_ci DEFAULT NULL,
  `last_name` varchar(32) COLLATE latin1_spanish_ci DEFAULT NULL,
  `gender` varchar(1) COLLATE latin1_spanish_ci DEFAULT NULL,
  `birthdate` date DEFAULT NULL,
  `city` varchar(32) COLLATE latin1_spanish_ci DEFAULT NULL,
  `state` varchar(2) COLLATE latin1_spanish_ci DEFAULT NULL,
  `picture` varchar(32) COLLATE latin1_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`)
